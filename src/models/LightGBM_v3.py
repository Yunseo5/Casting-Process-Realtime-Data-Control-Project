...
MODEL_OUTPUT = BASE_DIR / "data" / "models" / "LightGBM_v3.pkl"           
SCORE_OUTPUT = BASE_DIR / "data" / "models" / "LightGBM_v3_scores.csv"    
...
train_df = train_df.astype({"mold_code":"object", "EMS_operation_time":"object"})
test_df = test_df.astype({"mold_code":"object", "EMS_operation_time":"object"})
