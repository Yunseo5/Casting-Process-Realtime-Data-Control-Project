...
MODEL_OUTPUT = BASE_DIR / "data" / "models" / "LightGBM_v2.pkl"           
SCORE_OUTPUT = BASE_DIR / "data" / "models" / "LightGBM_v2_scores.csv"    
...
train_df = train_df.astype({"mold_code":"object"})
test_df = test_df.astype({"mold_code":"object"})
